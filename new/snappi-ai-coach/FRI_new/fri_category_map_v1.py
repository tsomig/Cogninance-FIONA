...
FRI_CATEGORY_MAP = {
    ...
    # Non-INSTANT fee variant for Instant transfers (Excel-sourced, prevents
    # fallback to STABILITY_INCOME via TRANSACTION_TYPE_FALLBACK)
    ...
    # Non-INSTANT fee variant for Instant receives (Excel-sourced, prevents
    # fallback to STABILITY_INCOME via TRANSACTION_TYPE_FALLBACK)
